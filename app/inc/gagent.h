...
#define GAGENT_HTTP_TIMEOUT        (80*ONE_SECOND)
#define GAGENT_MQTT_TIMEOUT        (80*ONE_SECOND)
...
#define CLOUD_HEARTBEAT          (80*ONE_SECOND)
#define CLOUD_MQTT_SET_ALIVE      (240*ONE_SECOND)//liangzt mod
...
#define FILE_TRANSFER_TIMEOUT (120 * ONE_SECOND)
...
#define XPG_CFG_FLAG_CONNECTED      (1<<0) 
#define XPG_CFG_FLAG_CHANGEPW       (1<<1) 
#define XPG_CFG_FLAG_CONFIG         (1<<2) 
#define XPG_CFG_FLAG_CONFIGSUCCESS  (1<<3) 
#define CFG_FLAG_TESTMODE           (1<<4)
#define XPG_CFG_FLAG_CONFIG_AIRKISS (1<<5)
...
#define GAGENT_MCU_STOP_SEND     0x27
...
#define AS xpg_assert(0) // 鏄剧ず浠ｇ爜浣嶇疆
...
#define MS (GAgent_Printf(GAGENT_INFO, __FILE__ ":" _STR(__LINE__) ":" _STR(__FUNC__) "TOP Level Error:malloc")) // 鍐呭瓨鍒嗛厤閿欒
#define MBM ((void)0) // 鏍囪锛岄渶瑕佹敞鎰忕殑鍦版柟
